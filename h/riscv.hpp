...
/*
 *  Preuzeto sa
 *  OS1_VEZBE07_RISCV_CONTEXT_SWITCH_1_SYNCHRONOUS
 * */
...
{
public:
    static int mode;  // 1 meaning kernel, 0 meaning user
...
private:
    static void mem_free_handler();
    static void mem_alloc_handler();
    static void handleSupervisorTrap();
    static void timerTrapHandler();
    static void consoleTrapHandler();
    static void somethingCrazyHandler();
};
